...
//    get_temperature(&temp10, sensor10);
    ...
    img.deleteSprite();
    int logger_id=1;  //20201022 added
   
    //シリアル出力
   // if (FG_SERIALOUT) { commend out
     sprintf(buf, "%02d,%02d:%02d:%02d.%01d,%4.4f,%4.4f,%4.4f,%4.4f,%4.4f,%4.4f,%4.4f,%4.4f,%4.4f,%4.4f" // 2020001022 modified
              , logger_id   // 20201022 added             , nowtime.t_hour
              , nowtime.t_min
              , nowtime.t_sec
              , nowtime.t_mil
              , temp1
